...
puts "Creating users..."
# Corregido: Usamos password y password_confirmation para que Devise los encripte bien
admin = User.create!(email: 'admin@eventhub.cl', password: 'password123', password_confirmation: 'password123', role: :admin)
gonzalo = User.create!(email: 'gsalinas@miuandes.cl', password: 'password123', password_confirmation: 'password123', role: :regular)
fer = User.create!(email: 'fernanda@miuandes.cl', password: 'password123', password_confirmation: 'password123', role: :regular)
seba = User.create!(email: 'sebastian@miuandes.cl', password: 'password123', password_confirmation: 'password123', role: :regular)
...
# Forzar inscripción simulando el pasado
